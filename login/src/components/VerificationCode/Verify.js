...
export default function Verify() {
    ...
    const handleBackPage = (event) => {
        window.location.href = 'email'; // تغییر به صفحه کد تایید
    }
    return (
        <div className={styles.div_frame1} style={{ direction: 'rtl' }}>


            <div className={styles.div_main_validation}>


                <div className={styles.top_div}>
                    <button class={styles.rounded_full}>
                        <img src={back} class={styles.back_btn} alt="icon" onClick={handleBackPage} />
                    </button>
                </div>
